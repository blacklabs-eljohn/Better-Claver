/**
 * Weather & Map Section for Better Claver Homepage
 * Displays real-time weather data and interactive map of Claver, Surigao del Norte
...
(function () {
  ...
  const WeatherService = {
    CACHE_KEY: 'claver_weather_cache',
    CACHE_TTL: 30 * 60 * 1000,
    API_URL: 'https://api.open-meteo.com/v1/forecast',
    COORDINATES: { lat: 9.5725, lon: 125.7331 },
  ...
  const WeatherUI = {
    render(container, data) {
      ...
      try {
        ...
        container.innerHTML = `
                <div class="weather-widget" role="region" aria-label="Current weather in Claver">
                    <div class="weather-current">
                        ...
                        <div class="weather-current-info">
                            ...
                            <div class="weather-current-location">
                                <i class="bi bi-geo-alt" aria-hidden="true"></i> Claver, Surigao del Norte
                            </div>
                        </div>
                    </div>
  ...
  const MapComponent = {
    ...
    initLeaflet(container) {
      try {
        ...
        // Add marker
        const marker = L.marker(this.CLAVER_CENTER).addTo(this.map);
        marker.bindPopup('<strong>Claver Municipal Hall</strong><br>Surigao del Norte 8410');
