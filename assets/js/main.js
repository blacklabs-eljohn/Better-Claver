...
function showInstallBanner() {
  ...
  banner.innerHTML =
    ...
    '<span>Install BetterClaver for quick access to services.</span>' +
    '</div>' +
    '<div class="pwa-install-actions">' +
    '<button class="pwa-install-btn" aria-label="Install BetterClaver app">Install</button>' +
