/**
 * BetterClaver Service Worker
 * Enterprise-grade PWA with versioned caching, runtime strategies, and offline resilience.
 */

var CACHE_VERSION = 'v3';
var STATIC_CACHE = 'betterclaver-static-' + CACHE_VERSION;
var RUNTIME_CACHE = 'betterclaver-runtime-' + CACHE_VERSION;
...
var PRECACHE_URLS = [
  ...
  '/assets/images/logo/better-claver-logo.svg',
  '/assets/images/logo/better-claver-logo-white.svg',
...
self.addEventListener('push', function (event) {
  ...
  event.waitUntil(
    self.registration.showNotification(data.title || 'BetterClaver', {
      body: data.body || '',
      icon: '/assets/images/logo/favicon.svg',
      badge: '/assets/images/logo/favicon.svg',
      tag: data.tag || 'betterclaver-notification',
      data: { url: data.url || '/' },
    })
  );
});
