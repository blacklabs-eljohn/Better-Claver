...
This document provides guidance for contributors migrating from the static HTML version to the React + TypeScript version of BetterClaver.org.

## Overview

BetterClaver.org now has two versions:
