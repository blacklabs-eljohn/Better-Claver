...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <section className="charter-section" aria-label="Citizen's Charter Service Guide">
        <div className="container">
          <div className="charter-inner">
            <div className="charter-header-container">
              <span className="charter-tag">{t('charter-tag')}</span>
              <h2 className="charter-title">{t('charter-title')}</h2>
              <p className="charter-desc">{t('charter-desc')}</p>
            </div>

            <div className="charter-grid">
              <div className="charter-card">
                <div className="charter-card-icon"><i className="bi bi-file-earmark-check"></i></div>
                <h3>{t('charter-step1-title')}</h3>
                <p>{t('charter-step1-desc')}</p>
              </div>
              <div className="charter-card">
                <div className="charter-card-icon"><i className="bi bi-send-check"></i></div>
                <h3>{t('charter-step2-title')}</h3>
                <p>{t('charter-step2-desc')}</p>
              </div>
              <div className="charter-card">
                <div className="charter-card-icon"><i className="bi bi-clipboard2-check"></i></div>
                <h3>{t('charter-step3-title')}</h3>
                <p>{t('charter-step3-desc')}</p>
              </div>
            </div>

            <div className="charter-action-panel">
              <div className="charter-action-content">
                <h4>{t('charter-download-title')}</h4>
                <p>{t('charter-download-desc')}</p>
              </div>
              <div className="charter-action-btn-wrapper">
                <Link href="/services/certificates" className="charter-action-btn">
                  <i className="bi bi-journal-text"></i> {t('charter-read-btn')}
                </Link>
              </div>
            </div>
          </div>
            ...
            <div className="weather-column">
              <div id="weather-container" aria-live="polite">
                <div
                  ...
                  role="region"
                  aria-label="Current weather in Claver"
                >
            ...
            <div className="map-column">
              <div className="map-card">
                <div
                  id="map-container"
                  role="application"
                  aria-label="Interactive map of Claver, Surigao del Norte"
                  data-map-loaded="iframe"
                >
                  <iframe
                    src="https://www.openstreetmap.org/export/embed.html?bbox=125.7131%2C9.5575%2C125.7531%2C9.5875&layer=mapnik&marker=9.5725%2C125.7331"
                    className="map-iframe"
                    title="Map of Claver, Surigao del Norte"
                    aria-label="OpenStreetMap showing Claver Municipal Hall, Surigao del Norte"
                    loading="lazy"
                  ></iframe>
                </div>
                <p className="map-attribution">
                  <i className="bi bi-geo-alt" aria-hidden="true"></i> Claver Municipal Hall, Nueva
                  Surigao del Norte 8410
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="home-contact-v2-grid">
            ...
            <a href="mailto:lguclaver.sdn@gmail.com" className="home-contact-v2-card">
              <div className="home-contact-v2-icon">
                <i className="bi bi-envelope-fill"></i>
              </div>
              <div className="home-contact-v2-content">
                <h3>{t('contact-email')}</h3>
                <p className="home-contact-v2-value">lguclaver.sdn@gmail.com</p>
            ...
            <div className="home-contact-v2-card">
              ...
              <div className="home-contact-v2-content">
                ...
                <span className="home-contact-v2-note">Claver, Surigao del Norte 8410</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Claver Info CTA */}
      <section className="quiz-cta-section" aria-label="Claver Info">
        <div className="container">
