...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'about-scope-tag': 'Scope & Boundaries',
    'about-scope-title': "What We Do (and What We Don't)",
    'about-scope-desc': 'Clear boundaries keep our platform focused, reliable, and transparent for every citizen.',
    'about-scope-in-title': 'What BetterClaver Does',
    'about-scope-in-1': 'Centralizes requirements, fees, and procedures for municipal services',
    'about-scope-in-2': 'Maps local government profiles, elected officials, and barangay contacts',
    'about-scope-in-3': 'Presents public budget allocations, fiscal summaries, and infrastructure data',
    'about-scope-in-4': 'Provides trilingual translations (English, Filipino, Surigaonon) for inclusivity',
    'about-scope-in-5': 'Maintains 100% open-source, community-driven code for public audit',
    'about-scope-out-title': 'What BetterClaver Does Not Do',
    'about-scope-out-1': 'Does not process online payments, issue clearances, or grant permits directly',
    'about-scope-out-2': 'Does not collect or store private government IDs, passwords, or personal tax records',
    'about-scope-out-3': 'Is not an official government department, agency, or official LGU entity',
    'about-scope-out-4': 'Does not replace emergency hotlines or official in-person municipal counters',
    'about-scope-out-5': 'Does not receive government funding, charge fees, or display commercial ads',
    'about-sources-tag': 'Data Integrity',
    'about-sources-title': 'Data Sources & Freshness',
    'about-sources-desc': 'All information presented on BetterClaver is gathered from verified, publicly accessible government publications and open data repositories.',
    'about-source-lgu-title': 'Official LGU Publications',
    'about-source-lgu-desc': 'Sourced directly from LGU Claver public notices, Executive Orders, and Sangguniang Bayan Resolutions.',
    'about-source-national-title': 'National Open Data',
    'about-source-national-desc': 'Cross-referenced with DBM budget releases, DILG Full Disclosure Policy Portal, COA Audit Reports, and DPWH releases.',
    'about-source-freshness-title': 'Audits & Updates',
    'about-source-freshness-desc': 'Information is periodically reviewed against official updates. Source citations are attached to every data view.',
  ...
  fil: {
    ...
    // Scope & Data Integrity
    'about-scope-tag': 'Saklaw at Hangganan',
    'about-scope-title': 'Ginagawa Namin (at Hindi Namin Ginagawa)',
    'about-scope-desc': 'Ang malinaw na hangganan ay nagpapanatili sa aming platform na nakatuon, maaasahan, at transparent para sa bawat mamamayan.',
    'about-scope-in-title': 'Ginagawa ng BetterClaver',
    'about-scope-in-1': 'Nagsasama-sama ng mga kinakailangan, bayarin, at pamamaraan para sa mga serbisyong munisipal',
    'about-scope-in-2': 'Nagtatala ng mga profile ng lokal na pamahalaan, mga inihalal na opisyal, at mga contact ng barangay',
    'about-scope-in-3': 'Naghaharap ng mga alokasyon sa badyet, buod sa pananalapi, at datos ng imprastraktura',
    'about-scope-in-4': 'Nagbibigay ng trilingual na pagsasalin (Ingles, Filipino, Surigaonon) para sa inklusibong access',
    'about-scope-in-5': 'Napananatili ang 100% open-source na code para sa pampublikong pagsusuri',
    'about-scope-out-title': 'Hindi Ginagawa ng BetterClaver',
    'about-scope-out-1': 'Hindi nagpoproseso ng online na bayad, naglalabas ng clearance, o nagbibigay ng permit nang direkta',
    'about-scope-out-2': 'Hindi nangongolekta o nagtatabi ng mga pribadong ID, password, o rekord ng buwis',
    'about-scope-out-3': 'Hindi isang opisyal na departamento ng gobyerno, ahensya, o opisyal na entidad ng LGU',
    'about-scope-out-4': 'Hindi pumapalit sa mga emergency hotline o opisyal na walk-in counter sa munisipyo',
    'about-scope-out-5': 'Hindi tumatanggap ng pondo mula sa gobyerno, naniningil ng bayad, o nagpapakita ng ads',
    'about-sources-tag': 'Integridad ng Datos',
    'about-sources-title': 'Pinagmulan at Pagiging Sariwa ng Datos',
    'about-sources-desc': 'Lahat ng impormasyong ipinapakita sa BetterClaver ay tinipon mula sa mga verified at pampublikong publikasyon ng gobyerno.',
    'about-source-lgu-title': 'Mga Opisyal na Publikasyon ng LGU',
    'about-source-lgu-desc': 'Kinuha nang direkta mula sa mga pampublikong abiso ng LGU Claver, Executive Orders, at Resolusyon ng Sangguniang Bayan.',
    'about-source-national-title': 'Pambansang Open Data',
    'about-source-national-desc': 'Sinuri kasama ang mga release ng DBM, DILG Full Disclosure Policy Portal, COA Audit Reports, at DPWH releases.',
    'about-source-freshness-title': 'Pagsusuri at Pag-update',
    'about-source-freshness-desc': 'Ang impormasyon ay pana-panahong sinusuri laban sa mga opisyal na update. Ang mga citation ay nakakabit sa bawat view.',
  ...
  sug: {
    ...
    // Scope & Data Integrity
    'about-scope-tag': 'Saklaw sanan Hangganan',
    'about-scope-title': 'Ginhimo Namo (sanan Dili Namo Ginhimo)',
    'about-scope-desc': 'An maklaro na hangganan nagapanatili sa amo platform na nakatuon, maaasahan, sanan transparent para sa tagsa ka lungsodnon.',
    'about-scope-in-title': 'Ginhimo nan BetterClaver',
    'about-scope-in-1': 'Nag-iipon nan mga kinahanglanon, bayad, sanan pamamaraan para sa mga serbisyong munisipal',
    'about-scope-in-2': 'Nagtala nan mga profile nan lokal na gobyerno, mga napili na opisyal, sanan mga contact nan barangay',
    'about-scope-in-3': 'Nagapresenta nan mga alokasyon sa badyet, buod sa pananalapi, sanan datos nan imprastraktura',
    'about-scope-in-4': 'Naghahatag nan trilingual na paghubad (Ingles, Filipino, Surigaonon) para sa inklusibong access',
    'about-scope-in-5': 'Napanatili an 100% open-source na code para sa pampublikong pagsusuri',
    'about-scope-out-title': 'Dili Ginhimo nan BetterClaver',
    'about-scope-out-1': 'Dili nagaproseso nan online na bayad, nagagawas nan clearance, o nagahatag nan permit nan direkta',
    'about-scope-out-2': 'Dili nagakolekta o nagatago nan mga pribadong ID, password, o rekord nan buwis',
    'about-scope-out-3': 'Dili usa ka opisyal na departamento nan gobyerno, ahensya, o opisyal na entidad nan LGU',
    'about-scope-out-4': 'Dili nagapuli sa mga emergency hotline o opisyal na walk-in counter sa munisipyo',
    'about-scope-out-5': 'Dili nagadawat nan pondo gikan sa gobyerno, naningil nan bayad, o nagapakita nan ads',
    'about-sources-tag': 'Integridad nan Datos',
    'about-sources-title': 'Pinagmulan sanan Pagkabag-o nan Datos',
    'about-sources-desc': 'Tanan impormasyon na ginapakita sa BetterClaver nakuha gikan sa mga verified sanan pampublikong publikasyon nan gobyerno.',
    'about-source-lgu-title': 'Mga Opisyal na Publikasyon nan LGU',
    'about-source-lgu-desc': 'Nakuha nan direkta gikan sa mga pampublikong abiso nan LGU Claver, Executive Orders, sanan Resolusyon nan Sangguniang Bayan.',
    'about-source-national-title': 'Pambansang Open Data',
    'about-source-national-desc': 'Ginsuri kauban an mga release nan DBM, DILG Full Disclosure Policy Portal, COA Audit Reports, sanan DPWH releases.',
    'about-source-freshness-title': 'Pagsusuri sanan Pag-update',
    'about-source-freshness-desc': 'An impormasyon ginapana-panahong sinusuri laban sa mga opisyal na update. An mga citation nakakabit sa tagsa ka view.',
