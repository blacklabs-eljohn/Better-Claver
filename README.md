...
A civic-tech initiative providing transparent access to municipal services, programs, and public funds of LGU Claver, Surigao del Norte, Philippines.
...
A **React + TypeScript** version of BetterClaver.org is now available for contributors who prefer modern tooling and component-based architecture.
...
BetterClaver.org is a volunteer-driven, open-source project that empowers the people of Claver with easy access to local government information. The platform aggregates public data from official government portals and presents it in a user-friendly, accessible format.

**Cost to the People of Claver = ₱0**

## Live Demo

Visit the live website: [https://betterclaver.org](https://betterclaver.org)
...
| **Claver Info**                  | Interactive quiz about Claver history and culture, linked from homepage CTA and footer across all pages                                                                                                           |
...
| **Brief History of Claver**      | Interactive timeline (1760–1957) with fully translated cards in all three languages                                                                                                                               |
...
git clone https://github.com/BetterClaver/betterclaver.git
...
- Tablet footer: left-aligned BetterClaver logo, tagline, and social icons to match the visual hierarchy of the brand column
...
- Added Claver Info CTA section on homepage with branded Lottie animation (brand blue `#0032A0`)
- Added Claver Info link to footer Quick Links across all 51 HTML pages and React Footer
- Added Brief History of Claver interactive timeline section on homepage (1760–1957)
...
- Added 54 translation keys for Claver Info footer link across all page contexts
...
- Updated copyright year to 2026, name to "BetterClaver.org"
- Footer copyright uses `flex-wrap: wrap; gap: 6px` layout with version badge right-aligned via `margin-left: auto`
- Removed trailing period after "BetterClaver.org" from all pages and all 3 translation languages
...
We welcome contributions from everyone! Whether you're a developer, designer, data researcher, content writer, translator, or a concerned citizen of Claver, your participation helps shape this project for all.
...
| ---------------------------------- | ------------------------------------------------------------------------- | ------------------------- |
| LGU Claver Official Website        | [claver.gov.ph](https://claver.gov.ph/)                                   | Services, Officials       |
| Sangguniang Bayan ng Claver        | [sangguniangbayan.claver.gov.ph](https://sangguniangbayan.claver.gov.ph/) | Ordinances, Resolutions   |
...
| Channel  | Link                                                                      |
| -------- | ------------------------------------------------------------------------- |
| Website  | [betterclaver.org](https://betterclaver.org)                              |
| Email    | volunteer@betterclaver.org                                                |
| Facebook | [@betterclaver.org](https://www.facebook.com/betterclaver.org)            |
| LinkedIn | [BetterClaver](https://www.linkedin.com/company/betterclaver/)            |
| Discord  | [Join Community](https://discord.com/invite/qeSu7RJkjQ)                   |
| GitHub   | [BetterClaver/betterclaver](https://github.com/BetterClaver/betterclaver) |
...
- LGU Claver for public data availability and transparency
- All volunteers and contributors who dedicate their time
- Open-source community for the tools and libraries used
- Citizens of Claver for their feedback and support

---

Made for the people of Claver, Surigao del Norte

## Developer

[Ramon Logan Jr.](https://ramonloganjr.com/) is a UAE-based full-stack developer and IT professional specializing in web development, design, cloud services, and cybersecurity. He is the developer behind BetterClaver.org, [Abakada.org](https://abakada.org), and the founder of the small cloud-based solutions initiative, [HelloPinas.com](https://hellopinas.com). Ramon actively contributes to civic-tech efforts like [BetterGov.ph](https://bettergov.ph) and is an individual participant in the [OpenJS Foundation](https://openjsf.org/).
